<?php
	...
	if(isset($_GET["keyword"])){
		...
		$orders_array = $FriendsManager->getAllData($keyword);
	}else{
		$orders_array = $FriendsManager->getAllData();
	}
	
	$offers_array = $FriendsManager->getOffersData();
...
<?php 
	...
	/*TABEL INIMESTEST; KELLE SÜNNIAASTA JÄÄB SOOVITUD VAHEMIKKU */
	...
	/*TABEL INIMESTEST; KELLE SOOVITUD VAHEMIKKU VAATAJA JÄÄB */
	} else {
		echo "<table class='table table-striped'>";
		echo "<tr>";
		echo "<th>Tellija</th>";
